...
namespace DatingApp.API.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        public AdminController(DataContext context, UserManager<User> userManager, IOptions<CloudinarySettings> cloudinayConfig)
        {
            _context = context;
        ...
        public async Task<IActionResult> EditRoles(string userName, RoleEditDto roleEditDto)
        {
            ...
            //select = selectRoles != null ? selectRoles : new string[] {};
